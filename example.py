...
# kitplugin.feature_builder("input_data/attack_types/friday_features_added.csv")
# print('friday done')
# quit()
...
for attack in attacks1:
    oldtime = time.time()
    convs.append(kitTester("thursday", attack, newFeatures='new_SRCIP_CHANN_SOCK_JIT'))
    newtime = time.time()
